...
If you play an older Version of the Randomizer (OoTR v7.1.128 or older) that does not support the .ootrs format you find your Sequences [here](https://github.com/DaruniasJoy/OoT-Custom-Sequences/archive/refs/heads/Old-Custom-Music-Format.zip) 
